...
<div id="main" class="wrap">
	...
	<div id="product" class="main">
		<h1>${product.name }</h1>
		<div class="infos">
			<div class="thumb"><img src="${product.filename }" /></div>
			<div class="buy">
				<p>商城价：<span class="price">${product.price }</span></p>
				<p>库存：<span class="price">${product.stock }</span></p>
				<p>分类：<span class="price">${product.cateid }</span></p>
				<p>子分类：<span class="price">${product.catechildid }</span></p>
				<div class="button"><input type="button" name="button" value="" onclick="goBuy(1)" /><a href="shoppingcart?type=add&pid=${product.productid }">放入购物车</a></div>
			</div>
			<div class="clear"></div>
		</div>
		<div class="introduce">
