...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改用户</h2>
		<div class="manage">
			<form action="../userServlet?type=update&uid=${user.userid } " method="post">
				<table class="form">
					<tr>
					...
					<tr>
						<td class="field">性别：</td>
						     ...
						     <c:choose>
							   ...
							   <c:otherwise> 
							    <td><input type="radio" name="sex" value="0"/>男 <input type="radio" name="sex" value="1"  checked="checked" />女</td>
							   </c:otherwise>
							</c:choose>
