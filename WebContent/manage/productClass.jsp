...
<div id="main" class="wrap">
	<div id="menu-mng" class="lefter">
		<div class="box">
			...
			</dl><a href="news-add.html">新增</a></em><a href="news.html">新闻管理</a></dd>
			</dl>
		</div>
	</div>
	<div class="main">
		...
		<div class="manage">
			<table class="list">
		        ...
		        <c:forEach items="${list }" var="cateitem" varStatus="status">
		      
		        <tr align="left" bgcolor="white">
		        
		        <td class="first w4 c">${cateitem.cateid }</td>
					<td>${cateitem.catename }</td>
					<td class="w1 c"><a href="../cateServlet?type=beforeUpdate&cid=${cateitem.cateid }">修改</a> <a href="../cateServlet?type=delete&cid=${cateitem.cateid }">删除</a></td>
				</tr>	
					<c:if test="${not empty cateitem.child }">
		   	  <c:forEach items="${cateitem.child }" var="childitem" varStatus="status">
		            <tr>
		            <td class="first w4 c">${childitem.cateid }</td>
					<td class="childClass">${childitem.catename }</td>
					<td class="w1 c"><a href="../cateServlet?type=beforeUpdate&cid=${childitem.cateid }">修改</a> <a href="../cateServlet?type=delete&cid=${childitem.cateid }">删除</a></td>
		            </tr>
		      </c:forEach>
		      </c:if>
