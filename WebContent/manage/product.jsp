		...
		<div class="manage">
			<table class="list">
		      ...
		      <tr align="center" bgcolor="white">
					...
					<td class="thumb"><img src="../images/product/0_tiny.gif" /><a href="../proServlet?type=detail&pid=${product.productid }" target="_blank">${product.name }</a></td>
					<td class="w1 c"><a href="../proServlet?type=beforeUpdate&pid=${product.productid }">修改</a> <a href="../proServlet?type=delete&pid=${product.productid }">删除</a></td>
		        </tr>
		    </c:forEach>
