...
$(document).ready(function(){
	 ...
	 $("#${category.parentid }").attr("selected",true);  
...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改分类</h2>
		<div class="manage">
			<form action="../cateServlet?type=update&cid=${category.categoryid } " method="post">
				<table class="form">
				<c:choose>
				...
				<tr>
		   	   ...
		   	   <c:forEach items="${parents }" var="parent" varStatus="status">
		            <option id="${parent.categoryid }" value="${parent.categoryid }">${parent.name }</option>
		        </c:forEach>
		      </c:if>
				</select>
					...
					<tr>
						...
						<td><input type="text" class="text" name="classname" value="${category.name }" /></td>
					</tr>
					<tr>
						<td></td>
