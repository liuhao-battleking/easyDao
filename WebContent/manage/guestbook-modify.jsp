...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="../commentServlet?type=update&cid=${comment.commentid } " method="post">
				<table class="form">
					<tr>
						<td class="field">留言ID：</td>
						<td><input type="text" class="text" name="commentid" value="${comment.commentid }" readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="field">留言姓名：</td>
						<td><input type="text" class="text" name="nickname" value="${comment.nickname }" readonly="readonly"/></td>
					</tr>
					<tr>
						<td class="field">留言内容：</td>
						<td><input type="text" class="text" name="content" value="${comment.content }" readonly="readonly"/></td>
					</tr>
					<tr>
