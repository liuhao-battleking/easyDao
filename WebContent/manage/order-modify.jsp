...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改订单</h2>
		<div class="manage">
			<form action="../orderServlet?type=update&oid=${ordershow.ordershowid } " method="post">
				<table class="form">
					<tr>
						<td class="field">订单ID：</td>
						<td><input type="text" class="text" name="orderid" value="${ordershow.ordershowid }" readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="field">订购人姓名：</td>
						<td><input type="text" class="text" name="name" value="${ordershow.username }" /></td>
					</tr>
					<tr>
						<td class="field">地址：</td>
						<td><input type="text" class="text" name="address" value="${ordershow.useraddress }" /></td>
					</tr>
					<tr>
						<td class="field">状态：</td>
						<td><input type="text" class="text" name="status" value="${ordershow.status }" /></td>
					</tr>
