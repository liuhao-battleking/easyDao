...
<div id="main" class="wrap">
	<div class="lefter">
		<div class="box">
			...
			<dl>
		        ...
		        <c:if test="${not empty cateitem.child }">
		   	   <c:forEach items="${cateitem.child }" var="childitem" varStatus="status">
		           <dd><a href="proServlet?type=getType&typeid=${childitem.cateid }">${childitem.catename }</a></dd>
		      </c:forEach>
		      </c:if>
			</c:forEach>
	      </c:if>
	...
	<div class="main">
		<div class="product-list">
			...
			<div class="pager">
				<ul class="clearfix">
					<li><a href="proServlet?type=getPage&pageNo=${page.pageNo-1 }">上一页</a></li>
					<li><a href="proServlet?type=getPage&pageNo=${page.pageNo+1 }">下一页</a></li>
					<li><font>当前第${requestScope.page.pageNo}页，共${requestScope.page.totalPages}页</font></li>
				</ul>
			</div>
		</div>
	</div>
